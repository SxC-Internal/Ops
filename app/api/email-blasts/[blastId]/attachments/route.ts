...
export async function GET(
    ...
    try {
        ...
        return apiError(getPublicErrorMessage(error, status, "Failed to list attachments"), status);
    }
}
...
export async function POST(
    ...
    try {
        ...
        const status = mapServiceErrorToStatus(error);
        return apiError(getPublicErrorMessage(error, status, "Failed to upload attachment"), status);
    }
}
